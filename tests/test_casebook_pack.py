"""Regression checks for the drift-sec-audit-lens casebook."""
...
from casebook.harness import assert_expected, drift_sec_audit_lens_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(drift_sec_audit_lens_summary(), assert_expected())
